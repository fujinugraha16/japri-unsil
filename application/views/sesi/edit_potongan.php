...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-6">
            ...
            <!-- Form Konfigurasi Potongan Harga -->
            <div class="card shadow mb-4">
                <div class="card-body">
                    <form class="edit-form" action="<?= base_url('crew/potongan/') . $crew_id['id_crew']; ?>"
                        method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control form-control-user" id="potongan" placeholder="0"
                                name="potongan">
